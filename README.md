...
日本・台湾・韓国・東南アジアの小規模地域芸術祭70件(終了・休止事例を含む)を収録(2026年7月調査・8月追補)。
...
4. 数分後に `https://www.keieiart.com/art-festival-db/` で公開されます
...
> **小規模地域芸術祭データベース**
> 日本・台湾・韓国・東南アジアの小規模・地域密着型芸術祭70件(終了・休止事例を含む)を横断調査したデータベース。
> 場所・予算・アーティスト数・開催間隔・連絡先・特徴を収録し、検索・絞り込みが可能(2026年7月調査)。
> https://www.keieiart.com/art-festival-db/
